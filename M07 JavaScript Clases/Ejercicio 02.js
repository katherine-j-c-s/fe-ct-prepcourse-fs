...
class Persona {
   ...
   detalle(){
      let propiedadesDePersona = {
         nombre: this.nombre,
         apellido: this.apellido,
         edad: this.edad,
         domicilio: this.domicilio,
      };
      return propiedadesDePersona;
   }
}
...
function agregarMetodo() {
   ...
   // Tu código:
   crearInstanciaPersona.prototype.datos = function () {
      let nombre = this.nombre;
      let edad = this.edad;
      let stringPresentacion = nombre + ", " + edad + " años."
      return stringPresentacion;
   }
}
